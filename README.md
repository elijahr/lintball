...
| Python       | `*.py`, `*.pyi`, `#!/usr/bin/env python`             | [autoflake][5], [autopep8][6], [black][14], [docformatter][7], [isort][15] |
| Ruby         | `*.rb`, `Fastfile`, `Gemfile`, `#!/usr/bin/env ruby` |                 [@prettier/plugin-ruby][16], [rubocop][17]                 |
